                ...
                child: Column(
                  children: [
                    Container(padding: EdgeInsets.all(10.0),
                      ...
                      child: Text('Hello, How was your day?',
                    ...
                    Container(padding: EdgeInsets.all(10.0),
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.only(
                              ...
                              topRight: Radius.circular(10),
                            topLeft: Radius.circular(10),)),
                      child: Text('The Day was really good ',
                        style: TextStyle(color: Colors.black, fontSize: 15,),
                      ),),
                    Spacer(),
                    Material(
                            ...
                            Expanded(
                              child: TextField(
                                decoration: InputDecoration(
                                  border: InputBorder.none, hintText: "Type a message", hintStyle: TextStyle(color: Colors.black45)),),
                            ),
                            Container(
